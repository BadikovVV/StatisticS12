...
#ifndef UnitInFieldsH
#define UnitInFieldsH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TFormINFields : public TForm
{
__published:	// IDE-managed Components
        ...
        void __fastcall CheckBox35Click(TObject *Sender);
        void __fastcall RxSwitch1On(TObject *Sender);
        void __fastcall RxSwitch1Off(TObject *Sender);
private:	// User declarations
public:		// User declarations
        __fastcall TFormINFields(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TFormINFields *FormINFields;
//---------------------------------------------------------------------------
#endif
